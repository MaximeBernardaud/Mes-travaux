...
class OrderCrudController extends AbstractCrudController
{
    ...
    {
        $updatePreparation = Action::new('updatePreparation', 'Préraration en cours', 'fas fa-box-open')->linkToCrudAction('updatePreparation');
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextField::new('getCarrierName', 'Transporteur'),
            MoneyField::new('getTotal', 'Total produit')->setCurrency('EUR'),
